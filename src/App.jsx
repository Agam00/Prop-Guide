      ...
      <div className="container mx-auto px-4 py-4">
        <div className={`flex flex-wrap justify-center gap-2.5 `}>
          {sections.map((section) => (
            <button
              className={`px-4 py-2 rounded-lg font-medium bg-orange-700 text-white  hover:bg-sky-700 transition-all duration-300 ease-in hover:rounded-3xl
 `}
              Key={section.id}
            >
  ...
  return (
    ...
    <div className={`min-h-screen bg-gray-800`}>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <h1 className="text-5xl font-bold mb-4">Props Explained</h1>
          <p
            className={`text-xl ${isDark ? "text-gray-300" : "text-gray-800"}`}
          >
            A comprehensive guid to understand props
          </p>
          <div
